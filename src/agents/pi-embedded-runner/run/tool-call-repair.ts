...
import { isToolCallBlockType } from "./tool-name-dispatch.js";
...
// Re-export the unused const so tree-shaking doesn't complain; it documents
// the snapshot-message limit used internally by the repair wrapper.
export { MAX_BTW_SNAPSHOT_MESSAGES };
